...
public class EmployeeRestController {
	...
	public ResponseEntity<?> createEmployee(@RequestBody Employee newEmp) {
		if (employeeRepository.findById(newEmp.getId()).isPresent()) {
			return new ResponseEntity<String>("A user with ID " + newEmp.getId() + " already exists.",
					HttpStatus.CONFLICT);
		}
	...
	public ResponseEntity<?> updateEmployee(@PathVariable Long id, @RequestBody Employee newEmp) {
		...
		return new ResponseEntity<String>("Unable to update.  Employee with id " + id + " not found.",
	...
	public ResponseEntity<?> deleteEmployee(@PathVariable Long id) {
		...
		return new ResponseEntity<String>("Unable to delete.  Employee with id " + id + " not found.",
				HttpStatus.NOT_FOUND);
	}
